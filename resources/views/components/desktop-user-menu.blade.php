            ...
            >
              <div class="space-y-1 p-2.5">
                <a
                  ...
                  class="group flex items-center justify-between gap-2 rounded-lg border border-transparent px-2.5 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 active:border-gray-100 dark:text-gray-200 dark:hover:bg-gray-700/75 dark:hover:text-white dark:active:border-gray-600"
                >
                  <svg
                  ...
                  <div
                    class="inline-flex rounded-full border border-gray-200 bg-gray-100 px-1.5 py-0.5 text-xs leading-4 font-semibold text-gray-700 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-50"
                  >
                    2
                  </div>
                </a>
              ...
              <div class="space-y-1 p-2.5">
                <form method="POST" action="{{ route('logout') }}">
                  ...
                  <button
                    ...
                    role="menuitem"
                    as="button"
                    class="group flex w-full items-center justify-between gap-2 rounded-lg border border-transparent px-2.5 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 active:border-gray-100 dark:text-gray-200 dark:hover:bg-gray-700/75 dark:hover:text-white dark:active:border-gray-600"
                  >
                    <svg
